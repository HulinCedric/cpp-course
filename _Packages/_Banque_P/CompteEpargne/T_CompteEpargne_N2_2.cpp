...
//
// Classe CompteEpargne - Tests unitaires des accesseurs de consultation
//                        (Cas nominaux)
//
// Auteur : A. Thuaire
//
...
void main () {
   ...
   CompteEpargne cpt_1(dupuy, 0.05f), cpt_2(durand, 0.03f); 
      ...
      Tests::Design("Controle des accesseurs de consultation", 3);
         ...
         Tests::Case("Accesseur numeroCompte"); { 
            ...
            Tests::Unit(4000001, cpt_1.numeroCompte());
            Tests::Unit(4000002, cpt_2.numeroCompte());
         }
