...
//
// Classe CompteCourant - Tests unitaires des cas d'anomalies
//
// Auteur : A. Thuaire
//
...
void main () {
   ...
   Tests::Begin("_Banque.CompteBancaire", "1.1.0");
   ...
   Titulaire durand("Durand", "Paul", "1981/01/03",  adresse_2);
      ...
      int compteur= 0;
         ...
         Tests::Case("Validite d'un compte courant"); {
         CompteCourant cpt(dupuy);
            ...
            try {cpt.executer(VERSEMENT,"xxx", 200.f);}
            catch (double e) {  
               Tests::Unit(-3.3, e); compteur++;
            }
         }
