...
void main () {
   ...
   Titulaire durand("Durand", "Paul", "1981/01/03",  adresse_2);
      ...
      Tests::Design("Controle du service totalDepots (premiere forme)", 3);
      ...
      ag1.ouvrirCompte(durand, 0.04f);
         ...
         Tests::Case("Operations sur les comptes courants"); {

            ag1.executer(8000001, VERSEMENT, "Cheque 567893", 220.f);       
            Tests::Unit(220.f, ag1.totalDepots('C'));

            ag1.executer(8000002, VERSEMENT, "Guichet 1001", 500.f);
            Tests::Unit(720.f, ag1.totalDepots('C'));
         }

         Tests::Case("Operations sur les comptes epargne"); {

            ag1.executer(4000001, VERSEMENT, "Cheque 567900", 1000.f);       
            Tests::Unit(1000.f, ag1.totalDepots('E'));

            ag1.executer(4000002, VERSEMENT, "Guichet 1001", 500.f);
            Tests::Unit(1500.f, ag1.totalDepots('E'));
         }
