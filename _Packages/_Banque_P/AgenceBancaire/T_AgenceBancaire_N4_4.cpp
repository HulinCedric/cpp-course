...
//
// Classe AgenceBancaire - Tests unitaires du service nombreOperations
...
void main () {
   ...
   Titulaire durand("Durand", "Paul", "1981/01/03",  adresse_2);
      ...
      Tests::Design("Controle du service nombreOperations (deuxieme forme)", 3);
      ...
      ag1.ouvrirCompte(durand, 0.03f);
         ...
         Tests::Case("Client dupuy"); {
            ...
            Tests::Unit(5, ag1.nombreOperations (_Banque::dateCourante()));
         }
         ...
         Tests::Case("Client durand"); {
            ...
            Tests::Unit(9, ag1.nombreOperations (_Banque::dateCourante()));
         }
