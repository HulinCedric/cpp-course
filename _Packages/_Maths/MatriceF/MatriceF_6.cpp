...
//
bool MatriceF::operator == (const MatriceF& op2) {
...
//
bool MatriceF::operator == (int op2) {
...
//
bool MatriceF::operator != (const MatriceF& op2) {return !(*this==op2);}
bool MatriceF::operator != (int op2) {return !(*this==op2);}
