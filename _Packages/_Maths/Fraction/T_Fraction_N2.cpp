...
void main () {
   ...
   Tests::Design("Controle des operateurs (Seconde partie)", 3);
      ...
      Fraction f9(-2,5), f10(-5,4);
         ...
         Tests::Unit("-7/12",  (f1-f2)->toString());
         Tests::Unit("23/12",  (f3-f4)->toString());
         Tests::Unit("-23/12", (f5-f6)->toString());
         Tests::Unit("19/6",   (f7-f8)->toString());
         Tests::Unit("17/20", (f9-f10)->toString());
      }
      ...
      Fraction f5(2,-3), f6(7,6), f7(7,-3), f8(1);
         ...
         Tests::Unit("1/20",  (f1-f2)->toString());
         Tests::Unit("-4/15", (f3-f4)->toString());
         Tests::Unit("-11/6",  (f5-f6)->toString());
         Tests::Unit("-10/3",  (f7-f8)->toString());
      }
      ...
      Fraction f1(-2,12),  f2(1,-5), f3(1,123), f4(4,-16);
         ...
         Tests::Unit("9/5",   (f2-(-2))->toString());
         Tests::Unit("1/123", (f3-0)->toString());
         Tests::Unit("-41/4",  (f4-10)->toString());
      }
