...
Tests::Begin("_Maths.Matrice", "2.1.0");
      ...
      Tests::Design("Surcharges de l'operateur -", 2);
         ...
         int W[3][3]= {{ -4, -2, -1}, {-1, -4, -2}, {-2, -1, -4}};
            ...
            Tests::Unit(attendu.toString(), (M-2).toString());
         }

         Tests::Case("Changement de signe d'une matrice / Matrice 3x3"); {
         Matrice M(3), attendu(3);

         int T[3][3]= {{ -2, 0, 1}, {1, -2, 0}, {0, 1, -2}};
         int W[3][3]= {{ 2, 0, -1}, {-1, 2, 0}, {0, -1, 2}};
            ...
            Tests::Unit(attendu.toString(), (-M).toString());
         }
