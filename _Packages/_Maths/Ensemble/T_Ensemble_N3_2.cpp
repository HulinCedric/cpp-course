   ...
   Tests::Begin("_Maths.Ensemble", "1.0.0");
      ...
      Tests::Design("Controle de l'operateur -=", 3); 
         ...
         Ensemble E1(&fEntierEquals);
            ...
            E1 -= new int(2);
            Tests::Unit("{}", E1.toString(&fEntierToString));
         }
         ...
         Ensemble E1(&fEntierEquals);
            ...
            E1 -= new int(4);
            Tests::Unit("{2, 6}", E1.toString(&fEntierToString));

            E1 -= new int(2);
            Tests::Unit("{6}", E1.toString(&fEntierToString));

         }

         Tests::Case("Tentative de retrait d'un element absent"); {
         Ensemble E1(&fEntierEquals);
