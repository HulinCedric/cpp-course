   ...
   Tests::Begin("_Maths.Ensemble", "1.0.0");
      ...
      Tests::Design("Controle de l'operateur =", 3); 
         ...
         Ensemble E1, E;
            ...
            E= E1; Tests::Unit("{}", E.toString(&fEntierToString));
         }

         Tests::Case("Cas d'un support vide / Copie d'un singleton"); {
         Ensemble E1(&fEntierEquals, &fEntierNew), E;

            E1 += new int(2);

            E= E1; Tests::Unit("{2}", E.toString(&fEntierToString));
         }

         Tests::Case("Cas d'un support vide / Source quelconque"); {
         Ensemble E1(&fEntierEquals, &fEntierNew), E;
            ...
            E= E1; Tests::Unit("{2, 4, 6}", E.toString(&fEntierToString));
         }

         Tests::Case("Cas d'un support quelconque / Source vide"); {
         ...
         Tests::Case("Cas d'un support quelconque / Source quelconque"); {
