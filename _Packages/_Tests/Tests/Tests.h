...
// Annee 2008_2009 - Charte des tests unitaires
//
// Classe Tests : services pour la mise en oeuvre de la charte de
//                tests unitaires presentes en cours
//
// Edition A    : cours 4
...
//    + Version 1.2.0  : ajout d'une forme polymorphe de Case pour
//                       pouvoir modifier le niveau "verbose" courant
//                       (IE_1 / Ex_2) 
//
// Edition B    : TP_11 / Compatibilite STL
