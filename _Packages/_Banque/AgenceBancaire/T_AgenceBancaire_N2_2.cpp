...
//
// Classe AgenceBancaire - Tests unitaires de la methode ouvrirCompte
//                         (Cas nominaux)
//
// Auteur : A. Thuaire
//
...
void main () {
   ...
   Titulaire durand("Durand", "Paul", "1981/01/03",  adresse_2);
      ...
      Tests::Design("Controle de la methode ouvrirCompte", 3);
      AgenceBancaire ag1(adresse_3);
   
         Tests::Case("Ouverture d'un compte courant"); {

            Tests::Unit(8000001, (int)ag1.ouvrirCompte(dupuy));
            Tests::Unit(1,        ag1.nombreComptesCourant());
         }

         Tests::Case("Ouverture d'un compte epargne"); {

            Tests::Unit(4000001, (int)ag1.ouvrirCompte(durand, 0.05f));
            Tests::Unit(1,        ag1.nombreComptesEpargne());
         }

         Tests::Case("Ouverture de plusieurs comptes"); {

            Tests::Unit(4000002, (int)ag1.ouvrirCompte(dupuy,  0.05f));
            Tests::Unit(8000002, (int)ag1.ouvrirCompte(durand));

            Tests::Unit(2, ag1.nombreComptesCourant());
